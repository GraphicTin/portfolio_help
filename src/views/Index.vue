<template>
	...
	<MainLayout>
        ...
        <MainButtonPool>
			...
			<MainPoolButton @click="openhouse()"></MainPoolButton>
			<MainPoolButton @click="guide() "   ></MainPoolButton>
			<MainPoolButton @click="online()"   ></MainPoolButton>
			<MainPoolButton @click="onsite()"   ></MainPoolButton>
